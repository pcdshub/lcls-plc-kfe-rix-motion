...
epicsEnvSet("ADS_MAX_PARAMS",   "13930")
...
epicsEnvSet("MOTOR_PREFIX",    "SP2K2:TXAS:MMS:RX:")
epicsEnvSet("MOTOR_NAME",      "01")
epicsEnvSet("DESC",            "Main.M38 / Axis 38 SP2K2-TXAS-TAR-MMS-RX")
...
epicsEnvSet("MOTOR_PREFIX",    "AT3K2:L2SI:MMS:")
epicsEnvSet("MOTOR_NAME",      "01")
epicsEnvSet("DESC",            "Main.M39 / Axis 39 AT3K2-SOLID-MMS-Y-01")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "AT3K2:L2SI:MMS:")
epicsEnvSet("MOTOR_NAME",      "02")
epicsEnvSet("DESC",            "Main.M40 / Axis 40 AT3K2-SOLID-MMS-Y-02")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "SP2K2:TXAS:MMS:YAG:")
epicsEnvSet("MOTOR_NAME",      "01")
epicsEnvSet("DESC",            "Main.M41 / Axis 41 SP2K2-TXAS-YAG-MMS-FOCUS")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:RIX:MOTION,PROJECT=plc-kfe-rix-motion.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.18.2,PLC_HOST=172.21.140.70")

#   LCLS General: * -> 2.12.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:RIX:MOTION,DEPENDENCY=LCLS_General,VERSION=2.12.0,VENDOR=SLAC")
#   lcls-twincat-common-components: * -> 3.9.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:RIX:MOTION,DEPENDENCY=lcls-twincat-common-components,VERSION=3.9.0,VENDOR=SLAC")
#   lcls-twincat-motion: * -> 4.1.1 (SLAC)
...
#   Tc3_Module: * -> 3.3.21.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:RIX:MOTION,DEPENDENCY=Tc3_Module,VERSION=3.3.21.0,VENDOR=Beckhoff Automation GmbH")
